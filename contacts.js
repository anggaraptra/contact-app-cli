...
const simpanContact = (nama, email, hp) => {
  ...
  console.log(chalk.blue.inverse.bold('Terimakasih sudah memasukan data.'));
};
...
const detailContact = (nama) => {
  ...
  console.log(`Nama : ${chalk.yellow.inverse.bold(contact.nama)}`);
  console.log(`No hp : ${contact.hp}`);
  if (contact.email) {
